...
GestoresDAO.prototype.cadastrarContato = function (contato, callback) {
    this._connection.query(`
    INSERT INTO sistemagestaodb.contatos (email, cpf) VALUES ('${contato.email}', '${contato.cpf}' );
    INSERT INTO sistemagestaodb.telefones (telefone, tipo, cpf) VALUES ('${contato.email}','${contato.tipo}', '${contato.cpf}' );
    ;`, callback);
}
